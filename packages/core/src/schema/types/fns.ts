...
export class FN_0x22520 extends MetadataCodec {
  f_0x00 = field(U32);
  f_0x04 = field(AssetReference);
  f_0x08 = field(U32);
}

export class FN_0x22080 extends MetadataCodec {
  object = field(AssetFromType);
}

export class FN_0x21c40 extends MetadataCodec {
  f_0x00 = field(U8);
  f_0x01 = field(U8);
  f_0x02 = field(U8);
...
export class FN_0x21dd0 extends MetadataCodec {
  f_0x00 = field(U32);
  f_0x04 = field(AssetReference);
}

export class FN_0x224c0 extends MetadataCodec {
  f_0x00 = field(U32);
  f_0x04 = field(AssetReference);
}

export class FN_0x5e2d0 extends Codec {
  count = field(I32);
...
export class FN_0x21f40 extends Codec {
